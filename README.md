...
4. Обмен сообщениями в чате с пользователем, без необходимости обновлять страницу (Если разрешить оповещения в браузере, при получении нового сообщения в открытом чате будут приходить оповещения от браузера).
